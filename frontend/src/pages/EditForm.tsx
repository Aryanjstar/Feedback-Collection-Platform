...
const EditForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: error.response?.data?.message || 'Failed to update form' });
    } finally {
      setSaving(false);
    }
  };
      ...
      <Layout>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">The form you're trying to edit doesn't exist.</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Update your feedback form. Changes will be reflected immediately.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Form Status */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Form Status</h2>
            <div className="flex items-center">
              <input
                type="checkbox"
                checked={originalForm?.isActive || false}
                onChange={(e) => {
                  // Handle form activation/deactivation
                  formsAPI.updateForm(formId!, { isActive: e.target.checked });
                }}
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
